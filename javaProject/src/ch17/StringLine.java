...
//JApplet은 Applet의 확장판으로 애플릿뷰어나 웹브라우저와 함계 쓰였으며
//게임 및 다양한 그래픽을 구사할 수 있다. 현재 HTEML5등 웹이 진화되면서 거의 사라져감.
//라이프사이클을 가지고 있다. init()-start()-stop-destroy()
//init()은 필수처리이며 나머지는 자동으로 처리되며 특정 웹브라우저의 페이지 이동 및 강제 종ㅈ료시킬 때 간혹 쓰인다.
public class StringLine extends JApplet{
	...
	public void paint(Graphics g) {
		...
		g.drawString("Greean String", 10, 80);
